  ...
  return (
    <div className="relative min-h-screen bg-midnight">
      ...
      <main className="relative z-10">
        {/* Hero Section */}
        <section id="section-hero" ref={heroAnimation.ref} className="min-h-screen flex items-center justify-center px-6 py-20 relative">
          <div className="max-w-7xl mx-auto w-full">
            <div className="relative flex items-center justify-between gap-12">
              {/* Text Content - Left Side */}
              <div className="flex-1 max-w-2xl">
                <h1 className={`text-hero font-bold text-gradient text-glow mb-8 transition-all duration-1000 ${
                  heroAnimation.isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'
                }`}>
                  {personalInfo.name}
                </h1>

                <p className={`text-subtitle text-sky-blue mb-6 transition-all duration-1000 delay-200 ${
                  heroAnimation.isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
                }`}>
                  {personalInfo.tagline}
                </p>

                <p className={`text-xl text-muted-blue max-w-xl transition-all duration-1000 delay-300 ${
        ...
        <section id="section-about" ref={aboutAnimation.ref} className="min-h-screen flex items-center justify-center px-6 py-24">
          <div className="max-w-5xl mx-auto w-full">
            <h2 className={`text-7xl font-bold text-gradient mb-16 text-center transition-all duration-1000 ${
            ...
            <div className="space-y-8">
              {/* Bio */}
              <div className={`glass-panel p-10 transition-all duration-1000 delay-200 ${
              ...
              {/* Quote */}
              <div className={`glass-panel p-10 border-l-4 border-l-aurora transition-all duration-1000 delay-400 ${
                aboutAnimation.isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'
              }`}>
